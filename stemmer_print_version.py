class Stemmer:
    #Initialize
    suf_sub_rule,suffix_del,suffix_exist,  suffix_desc, suffix_ins , suffix_morph, suffix_type, \
    suffix_ign, dub_suffix ,dub_suffix_morph,dub_suffix_desc, pre_sub_rule, prefix_del,prefix_desc,\
    prefix_ins, prefix_morph, prefix_type,ht_root,  suffix_ht, alt_root, ht_suffix, prefix_tm,\
    ht_prefix=dict(),dict(),dict(),dict(),dict(),dict(),dict(),dict(),dict(),dict(),dict(),dict(),\
